...
{
    public class BankaHareketRepository : Repository<BankaHareket>, IBankaHareketRepository
    {
        public BankaHareketRepository(IsbaSatisWebDbContext context) : base(context)
        {
        }
    }
}
