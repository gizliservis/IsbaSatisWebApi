...
{
    public class StokHareketRepository : Repository<StokHareket>, IStokHareketRepository
    {
        public StokHareketRepository(IsbaSatisWebDbContext context) : base(context)
        {
        }
    }
}
