...
{
    public class KasaHareketRepository : Repository<KasaHareket>, IKasaHareketRepository
    {
        public KasaHareketRepository(IsbaSatisWebDbContext context) : base(context)
        {
        }
    }
}
