...
{
    public class HizliSatisGrupRepository : Repository<HizliSatisGrup>, IHizliSatisGrupRepository
    {
        public HizliSatisGrupRepository(IsbaSatisWebDbContext context) : base(context)
        {
        }
    }
}
