        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ekleyen = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
                    EklenmeTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Duzenleyen = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OdemeTuruId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CariId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Tarih = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Tutar = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tarih = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PlasiyerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IskontoOrani = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
